...
> ⚠️ **Archived October 2025:** Information here predates the current Google Sign-In regression. Validate against `../../status/PROJECT_STATUS.md` before relying on it.

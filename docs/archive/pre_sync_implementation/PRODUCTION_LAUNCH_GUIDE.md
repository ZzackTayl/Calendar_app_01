...
1. **Review Monitoring Dashboards**
   - Open your crash/error monitoring tool
   - Review new issues
...
3. **Watch for Crashes**
   ...
   - Your monitoring tool's dashboard
...
- [ ] Error trends from your monitoring tool
- [ ] User growth metrics
- [ ] Feature requests
- [ ] Performance metrics
...
1. **Monitoring Alerts** (Email on critical errors)
   - Configure alerting in your monitoring tool
   - Create rules for critical error thresholds
   - Notify the on-call team for new critical issues
...
2. **Monitor Logs:**
   ...
   - Monitoring tool: provider dashboard

...
* **Crash/Analytics:** _None_ (evaluate options like Firebase Crashlytics when needed)
...
* **Crash/Error:** _Not configured yet_ — evaluate Firebase Crashlytics, Sentry, or in-house tooling once crash reporting becomes a priority.

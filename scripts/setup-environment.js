...
const ENV_TEMPLATES = {
  local: {
    ...
    // Secrets (set via CI/secret manager or add locally to .env; do not commit):
    // NEXTAUTH_SECRET: <set via CI or local .env>
    // ENCRYPTION_KEY: <set via CI or local .env>
    // SUPABASE_SERVICE_ROLE_KEY: <set via CI or local .env>
    // SENDGRID_API_KEY: <set via CI or local .env>
    // RESEND_API_KEY: <set via CI or local .env>
...
# - Set secrets via CI/CD or a secret manager
# - For local dev, add secrets manually to this file (gitignored)
#
`;

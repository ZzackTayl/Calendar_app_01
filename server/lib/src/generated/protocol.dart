...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    t ??= T;
    if (t == _i3.Calendar) {
      return _i3.Calendar.fromJson(data) as T;
    }
    if (t == _i4.User) {
      return _i4.User.fromJson(data) as T;
    }
    if (t == _i1.getType<_i3.Calendar?>()) {
      return (data != null ? _i3.Calendar.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Calendar') {
      return deserialize<_i3.Calendar>(data['data']);
    }

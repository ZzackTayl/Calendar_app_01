...
-- 2. CONTACTS TABLE
-- ============================================
-- Stores partner/contact relationships
...
-- Event invites policies: users can manage invites for their own events
CREATE POLICY "Users can view invites for own events"

...
6. [ ] Onboarding screens - Full accessibility
7. [ ] Settings screen - Full accessibility
8. [ ] People & Groups screen - Full accessibility
9. [ ] Event creation dialog - Full accessibility

### Testing & Validation
10. [ ] VoiceOver testing on iOS
11. [ ] TalkBack testing on Android
12. [ ] NVDA testing on Web
13. [ ] Automated accessibility audit (DevTools)

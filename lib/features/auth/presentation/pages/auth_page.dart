...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    if (_showSignUp) {
      await authCubit.signUpWithEmail(email: email, password: password);
    } else {
      await authCubit.signInWithEmail(email: email, password: password);
    }
    ...
    if (state.status.isSuccess) {
      ...
      final l10n = AppLocalizations.of(context);
      final displayMessage = state.message.isEmpty 
          ? l10n.authErrorAuthFailed 
          : state.message;
              ...
              child: ConstrainedBox(
                ...
                child: BlocBuilder<AuthCubit, AuthState>(
                  builder: (context, authState) {
                    final isProcessing = authState.status.isLoading;
                          ...
                          children: [
                            ...
                            SemanticButton(
                              ...
                              child: SizedBox(
                                ...
                                child: FilledButton(
                                  onPressed:
                                      isProcessing ? null : _handleSubmit,

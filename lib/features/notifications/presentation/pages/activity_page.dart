// Activity Screen - Rebuilt to match Figma design with BLoC
...
class _ActivityScreenState extends State<ActivityScreen> {
  ...
  Future<void> _removeActivity(
    ...
    await notificationCubit.deleteNotification(notification.id);
        ...
        SnackBar(
          ...
          action: SnackBarAction(
            ...
            onPressed: () {
              ...
              notificationCubit.restoreNotification(notification.id);
            },
          ),
        ),
      );
        ...
        child: SafeArea(
          ...
          child: BlocBuilder<NotificationCubit, NotificationState>(
            builder: (context, notificationState) {
              if (notificationState.status.isLoading) {
                return const Center(child: CircularProgressIndicator());
              }

              if (notificationState.status.isFailure) {
                return Center(
                  child: Text('Error loading activity: ${notificationState.message}'),
                );
              }

              final notifications = notificationState.notifications;
              final contacts = context.watch<ContactCubit>().state.contacts;
              ...
              final recentNotifications = notifications
                  ...
                  .toList();
              final sorted = [...recentNotifications]
                ..sort(
  ...
  _ActivityVisuals _activityVisuals(
    ...
    switch (type) {
      ...
      case app_notification.NotificationType.partnerAccepted:
        Color borderColor = AppColors.activityGreen;

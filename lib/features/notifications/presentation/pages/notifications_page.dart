...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  @override
  Widget build(BuildContext context) => const _NotificationsPageContent();
}
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NotificationCubit, NotificationState>(
      builder: (context, notificationState) {
        final visibleCount = notificationState.centerNotifications.length;
        ...
        return Scaffold(
          ...
          body: AppGradientBackground(
            child: Builder(
              builder: (context) {
                if (notificationState.status == AppStateStatus.loading &&
                ...
                if (notificationState.status == AppStateStatus.failure &&
                    notificationState.notifications.isEmpty) {
                  return Center(
                    child: Text(
                      'Error loading notifications: ${notificationState.message}',
                ...
                final visible = notificationState.centerNotifications;
                ...
                return Column(
                  children: [
                      ...
                      child: ListView(
                        ...
                        children: [
                          for (var i = 0; i < primary.length; i++) ...[
                            _buildNotificationItem(context, primary[i]),
                    ...
                    _buildFooter(context, visible.isNotEmpty),
                  ],
                );
              },
            ),
          ...
          if (hasNotifications) ...[
            SizedBox(
              ...
              child: FilledButton(
                ...
                onPressed: () async {
                  await context.read<NotificationCubit>().clearAll();
                  if (!context.mounted) {
                    return;
                  }
    ...
    switch (notification.type) {
      case app_notification.NotificationType.eventInvite:
        if (notification.metadata != null &&
          ...
          await EventInviteResponseSheetBloc.show(context, inviteId);
        } else {

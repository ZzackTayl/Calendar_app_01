...
import '../datasources/apple_calendar_data_source.dart';

class AppleCalendarRepositoryImpl implements ExternalCalendarRepository {
  final AppleCalendarDataSource dataSource;

  AppleCalendarRepositoryImpl({required this.dataSource});
  ...
  @override
  bool get isPlatformSupported => dataSource.isPlatformSupported;
}

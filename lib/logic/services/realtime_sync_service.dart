...
class RealtimeSyncService {
  ...
  static Future<void> Function(Map<String, dynamic>, Map<String, dynamic>)? onEventUpdated;
  ...
  static Future<void> Function(Map<String, dynamic>, Map<String, dynamic>)? onContactUpdated;
      ...
      _contactsChannel!
          .onPostgresChanges(
            ...
            callback: (payload) async {
              ...
              switch (eventType) {
                case PostgresChangeEvent.insert:
                  if (onContactInserted != null && payload.newRecord.isNotEmpty) {
                    await onContactInserted!(payload.newRecord);
                  }
                  break;
                case PostgresChangeEvent.update:
                  if (onContactUpdated != null && payload.newRecord.isNotEmpty) {
                    await onContactUpdated!(payload.newRecord, payload.oldRecord);
                  }
                  break;
                case PostgresChangeEvent.delete:
                  if (onContactDeleted != null && payload.oldRecord.isNotEmpty) {

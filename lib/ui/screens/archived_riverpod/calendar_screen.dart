...
class _CalendarScreenState extends ConsumerState<CalendarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedConnectionFilter =
        ref.watch(selectedConnectionFilterProvider);
  ...
  Widget _buildConnectionSelector({
    ...
    final fallbackFilterId = options.isNotEmpty ? options.first.filterId : null;
    ...
    final selectedValue = selectedFilter.when(
      data: (value) => options.any((option) => option.filterId == value)
          ? value
          : fallbackFilterId,
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: palette.isDark
                        ...
                        : AppColors.cardBorderBabyBlue.withValues(alpha: 0.7),
                    width: 1.4,
                  ),

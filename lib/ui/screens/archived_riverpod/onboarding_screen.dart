...
// import '../../logic/providers/auth_providers.dart'; // TODO: Replace with AuthCubit when migrating this screen
...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  Future<void> _fetchContacts() async {
    // TODO: Replace with AuthCubit when migrating this screen
    // final ownerId = ref.read(currentUserProvider)?.id;
    const String? ownerId = null; // Placeholder until migration
    if (ownerId == null) {
      setState(() {

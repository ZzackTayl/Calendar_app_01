...
grep -r "supabase_url\|SUPABASE_URL" lib/
grep -r "supabase_anon_key\|SUPABASE_ANON_KEY" lib/
...
```env
SUPABASE_ANON_KEY=eyJ...  # This is correct (public key)
# NOT: SUPABASE_SERVICE_KEY=... (admin key - never in app!)
```

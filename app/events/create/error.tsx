    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-0 shadow-xl bg-slate-800/90 backdrop-blur border-slate-700">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-white">Create Event Error</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-slate-300 text-center">
            There was an error loading the create event page. This might be related to the new privacy model.
          </p>

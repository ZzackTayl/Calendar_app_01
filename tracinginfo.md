...
## [Spans Conventions](#spans-conventions)
...
### [Common Span Attributes](#common-span-attributes)
...
#### [Session Data Attributes](#session-data-attributes)
...
### [MCP Server Span Types](#mcp-server-span-types)
